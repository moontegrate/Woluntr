export const CheckboxTheme = {
    "root": {
        ...
        "color": {
            ...
            "purple": "focus:ring-volunteer-color dark:ring-offset-volunteer-color dark:focus:ring-volunteer-color text-volunteer-color",
            ...
            "green": "focus:ring-main-color dark:ring-offset-main-color dark:focus:ring-main-color text-main-color",
