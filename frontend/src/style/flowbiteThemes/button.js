export const ButtonTheme = {
    ...
    color: {
        ...
        light: "text-gray-900 bg-neutral-color enabled:hover:bg-neutral-accent-color focus:ring-4 focus:ring-cyan-300 dark:bg-gray-600 dark:text-white dark:border-gray-600 dark:enabled:hover:bg-gray-700 dark:enabled:hover:border-gray-700 dark:focus:ring-gray-700",
        purple: "text-black bg-volunteer-accent-color border border-transparent enabled:hover:bg-volunteer-accent-color focus:ring-4 focus:ring-volunteer-accent-color dark:bg-volunteer-accent-color dark:enabled:hover:bg-volunteer-accent-color dark:focus:ring-volunteer-accent-color",
        ...
        green: "text-black bg-main-accent-color border border-main-accent-color enabled:hover:bg-main-accent-hover focus:ring-4 focus:ring-main-accent-color dark:bg-main-accent-color dark:text-white dark:border-main-accent-color dark:enabled:hover:bg-main-accent-hover dark:enabled:hover:border-main-accent-hover dark:focus:ring-main-accent-color",
