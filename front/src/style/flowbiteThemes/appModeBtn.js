export const AppModeBtnTheme = {
    ...
    color: {
        ...
        info: "text-black bg-white border border-transparent focus:ring-4 focus:ring-white dark:bg-cyan-600 dark:enabled:hover:bg-cyan-700 dark:focus:ring-cyan-800",
