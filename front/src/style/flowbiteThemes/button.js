export const ButtonTheme = {
    ...
    color: {
        ...
        info: "text-black bg-main-color border border-transparent enabled:hover:bg-main-color-hover focus:ring-4 focus:ring-white dark:bg-cyan-600 dark:enabled:hover:bg-cyan-700 dark:focus:ring-cyan-800",
